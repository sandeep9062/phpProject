...
require_once "config.php";
 $sqlr = "SELECT * FROM settings WHERE id='1'";
...
$sql = "UPDATE settings SET recharge='$rech',withdraw='$with',bonus='$bonus',support='$support',telegroup='$group' WHERE id='1' ";
...
if ($conn->query($sql) == TRUE) {
    ...
    echo '<h1  style="text-align: center;" > Error'. mysqli_error($conn) .'</h1>';
}
       ...
       <h1>minimum recharge:</h1>
          ...
          <br>
            <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    ...
                    alt=""><input data-v-309ccc10="" type="text"  name="rech" value="<?php echo  $rowr[recharge]?>"
                    placeholder="minimun recharge"><span data-v-309ccc10="" class="tips_span">Minimum Recharge</span></div>  
                    
                     <h1>minimum withdraw:</h1>
        
            
          <br>
                    <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    src="data:image/png;base64,"
                    alt=""><input data-v-309ccc10="" type="text"  name="with" value="<?php echo  $rowr[withdraw]?>"
                    placeholder="minimun withdraw"><span data-v-309ccc10="" class="tips_span">Minimum Withdraw</span></div> 
          ...
          <br>
                    <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    src="data:image/png;base64,"
                    alt=""><input data-v-309ccc10="" type="text"  name="bonus" value="<?php echo  $rowr[bonus]?>"
                    placeholder="Referal bonus"><span data-v-309ccc10="" class="tips_span">Referal bonus</span></div> 
          ...
          <br>
                    ...
                    <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    src="data:image/png;base64,"
                    alt=""><input data-v-309ccc10="" type="text"  name="group" value="<?php echo  $rowr[telegroup]?>"
                    placeholder="telegram group"><span data-v-309ccc10="" class="tips_span">telegram group</span></div>
          ...
          <br>
                    ...
                    <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    src="data:image/png;base64,"
                    alt=""><input data-v-309ccc10="" type="text"  name="support" value="<?php echo  $rowr[support]?>"
                    placeholder="telegram support"><span data-v-309ccc10="" class="tips_span">telegram support</span></div> 
