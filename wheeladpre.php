...
$optv="SELECT SUM(amount) as total FROM `vipbetting` WHERE status='pending' AND ans='yellow'";
$optresv=$conn->query($optv);
$sumv= mysqli_fetch_assoc($optresv);
$yellow=round($sumv['total'],2);
...
">Jhon Doe</h6>
     ...
     <h2 style="font-size:20px;padding:10px;  text-align:center;" onclick="window.location.href='wheeladpre'">Circle</h2>
 ...
 <div data-v-309ccc10="" class="recharge">
        <div data-v-309ccc10="" class="recharge_box">
             <h1>Red:₹&nbsp<?php echo $red;?></h1>
             <h1>Green:₹&nbsp<?php echo $green;?></h1>
             <h1>Yellow:₹&nbsp<?php echo $yellow;?></h1>
