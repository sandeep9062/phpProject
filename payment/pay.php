...
<div  style="display: flex; justify-content: center;" >
     <div id="qrcode" title="upi://pay?pa=<?php echo $upiid; ?>&amp;pn=JharGames&amp;tn=recharge&amp;am=<?php echo $am; ?>&amp;cu=INR">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=upi%3A%2F%2Fpay%3Fpa%3D<?php echo urlencode($upiid); ?>%26pn%3DJharGames%26tn%3DRecharge%26am%3D<?php echo $am; ?>%26cu%3DINR" alt="UPI QR Code for Jhar Games" style="width: -webkit-fill-available;">
                </div>
...
<style>
                ...
                @media only screen and (max-width: 600px) {
                    /* Override the inline width using !important */
                    #qrcode img {
                        width: 120px !important; /* Adjust the size as needed */
                        height: auto !important;
                    }

                    /* Optionally, adjust the container if needed */
                    .container-fluid.highlight > div {
                        max-width: 100% !important;
                        padding: 0 10px; /* Optional: Add some padding */
                    }

                    /* Ensure flex container centers the QR code properly */
                    #qrcode {
                        display: flex;
...
<div class="img-row">
<img onclick="dis('example1.png')" src="small1.png">
<img onclick="dis('example2.png')" src="small2.png">
</div>
<div class="img-row">
<img onclick="dis('example3.png')" src="small3.png">
<img onclick="dis('example4.png')" src="small4.png">
</div>
<div class="img-row">
<img onclick="dis('example5.png')" src="small5.png">
</div>
</div>
</div>
</div>
...
<img id="big-img" src="/example1.png">
<button id="close" class="btn-close" style="color: rgb(0, 0, 0); border-color: rgb(0, 0, 0);"> <span aria-hidden="true">&times;</span></button>
</div>
