...
switch ($prices) {
  ...
  case "1":
    ...
    $conn->query($addwin0);
       //
     $addwin0="INSERT INTO trans (username,reason,amount,time,type) VALUES ('$winner0', 'FastParity order income','$winamount0','$akshay','add')";
    $conn->query($addwin0);
...
$conn->query($addwin12);
       //
     $addwin0="INSERT INTO trans (username,reason,amount,time,type) VALUES ('$winner2', 'FastParity order income','$winamount2','$akshay','add')";
    $conn->query($addwin0);
}
...
$conn->query($addwin13);
    ...
    //
     $addwin0="INSERT INTO trans (username,reason,amount,time,type) VALUES ('$winner3', 'FastParity order income',+'$winamount3','$akshay','add')";
    $conn->query($addwin0);
}
...
$conn->query($addwin14);
    //
     $addwin0="INSERT INTO trans (username,reason,amount,time,type) VALUES ('$winner4', 'FastParity order income','$winamount4','$akshay','add')";
    $conn->query($addwin0);
...
$conn->query($addwin11);
 ...
 //
     $addwin0="INSERT INTO trans (username,reason,amount,time,type) VALUES ('$winner1', 'FastParity order income','$winamount1','$akshay','add')";
    $conn->query($addwin0);
}
...
$conn->query($addwin15);
 ...
 //
     $addwin0="INSERT INTO trans (username,reason,amount,time,type) VALUES ('$winner5', 'FastParity order income','$winamount5','$akshay','add')";
    $conn->query($addwin0);
}
...
$conn->query($addwin112);
 ...
 //
     $addwin0="INSERT INTO trans (username,reason,amount,time,type) VALUES ('$winner12', 'FastParity order income','$winamount12','$akshay','add')";
    $conn->query($addwin0);
}
