...
$sql = "UPDATE admin SET password='$username' WHERE id='1'";
...
if ($conn->query($sql) === TRUE) {
    echo '<h1  style="text-align: center;">Password Update sucessfully</h1>';
} else {
...
">Jhon Doe</h6>
 ...
 <div data-v-309ccc10="" class="recharge">
        ...
        <form action="" id="adminverify" method="POST" class="form-signup">
            <h2 style="padding:10px;">Enter the Password</h2>
            <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    ...
                    placeholder="New password"><span data-v-309ccc10="" class="tips_span">Period</span></div>
