...
<head>
    ...
    <script>
        function pageRedirect() {
            window.location.replace("https://jhargames.com/#/recharge");
        }
...
">
            <div style="margin: 0 auto;max-width: 520px">
                ...
                <div class="box">
                    <div class="text-left">
                        ...
                        <div class="img-row">
                            <img onclick="dis('/9987/example1.png')" src="/9987/small1.png">
                            <img onclick="dis('/9987/example2.png')" src="/9987/small2.png">
                        </div>
                        <div class="img-row">
                            <img onclick="dis('/9987/example3.png')" src="/9987/small3.png">
                            <img onclick="dis('/9987/example4.png')" src="/9987/small4.png">
                        </div>
                        <div class="img-row">
                            <img onclick="dis('/9987/example5.png')" src="/9987/small5.png">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="show-big-img" style="display: none;">
        <img id="big-img" src="/9987/example1.png">
    ...
    <div style="width:0;height:0" id="hide-img">
        <img src="/9987/example1.png">
        <img src="/9987/example2.png">
        <img src="/9987/example3.png">
        <img src="/9987/example4.png">
        <img src="/9987/example5.png">
    </div>
