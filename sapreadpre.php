...
$optp="SELECT period,nxt FROM `sapreperiod`";
...
$optb="SELECT SUM(amount) as total FROM `saprebetting` WHERE status='pending' AND ans='big'";
$optresb=$conn->query($optb);
$sumb= mysqli_fetch_assoc($optresb);
...
">Jhon Doe</h6>
     ...
     <h2 style="font-size:20px;padding:10px; text-align:center;" onclick="window.location.href='sapreadpre'">Sapre</h2>
 ...
 <div data-v-309ccc10="" class="recharge">
        <div data-v-309ccc10="" class="recharge_box">
             ...
             <h1>Small:₹&nbsp<?php echo $small;?></h1><br>
             <h1>Big:₹&nbsp<?php echo $big;?></h1><br>
        ...
        <form action="saprepre" id="pre" method="POST" class="form-signup">
