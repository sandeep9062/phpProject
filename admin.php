...
$opt="SELECT SUM(withdraw) as total FROM `record` WHERE status='Withdrawing' ";
...
$opt1="SELECT SUM(recharge) as total1 FROM `recharge` WHERE status='Success'";
...
$opt10="SELECT SUM(withdraw) as total10 FROM `record` WHERE status='wait'";
...
$opt9t = "SELECT COUNT(*) as total9 FROM `users` WHERE DATE(`created_at`) = CURDATE()";
...
$optt="SELECT SUM(withdraw) as total FROM `record` WHERE status='Withdrawing' AND  DATE(`created_at`) = CURDATE() ";
...
$opt10t="SELECT SUM(withdraw) as total10 FROM `record` WHERE status='Applying' AND  DATE(`created_at`) = CURDATE()";
...
">Jhon Doe</h6>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4" style="background-color: #4634ff  !important;">
            ...
            <br>
            <br>
            <h2 style="font-size:20px;padding:5px; color:Black; text-align:center;"onclick="window.location.href='settings'"> Click here for settings</h2>
             <h2 style="font-size:20px;padding:5px; color:Black; text-align:center;"onclick="window.location.href='aviset'"> Click here for jetX prediction</h2>
             <h2 style="font-size:20px;padding:5px; color:Black; text-align:center;"onclick="window.location.href='complaints'"> Click here for Complaints</h2>
           <h2 style="font-size:20px;padding:5px; color:Black; text-align:center;"onclick="window.location.href='getdetails'"> Click here to get userdetails</h2>
            <h2 style="font-size:20px;padding:5px; color:Black; text-align:center;"onclick="window.location.href='gift'"> Click here to create gift card</h2>
                    <h2 style="font-size:20px;padding:5px; color:Black; text-align:center;"onclick="window.location.href='upi'"> Click here to change UPI ID</h2>
                 ...
                 <h2 style="font-size:20px;padding:5px; color:black; text-align:center;"onclick="window.location.href='unblock'"> Click Here to Unblock user</h2>
                  ...
                  <h2 style="font-size:20px;padding:5px; color:black; text-align:center;"onclick="window.location.href='updateotp'"> Click Here to update OTP</h2>
                    <!--<h2 style="font-size:20px;padding:5px; color:black; text-align:center;"onclick="window.location.href='updateadmin'"> Click Here to change admin password</h2>-->
...
">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Contact Developer</a>                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                           
                            Designed By <a href="https://t.me/SoumyaGamers">zhang1717</a>
