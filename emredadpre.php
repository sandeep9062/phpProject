...
$optp="SELECT period,nxt FROM `emredperiod`";
...
">Jhon Doe</h6>
     ...
     <h2 style="font-size:20px;padding:10px;  text-align:center;"  onclick="window.location.href='emredadpre'">Parity</h2>
...
">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="https://t.me/SoumyaGamers">Contact Developer</a>                        </div>
