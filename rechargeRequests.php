...
while($row2 = mysqli_fetch_array($result2))
{
    ...
    $image='"https://fiewin20.com/payment/'.$row2[6].'.jpeg"';
    $dataRow = $dataRow."<tr><td></td><td>$row2[1]</td><td>$row2[5]</td><td>$row2[6]</td><td>$row2[2]</td><td onclick='window.location.href=$alink;' style='background:green;'>YES</td><td onclick='window.location.href=$dlink;'style='background:red;'>NO</td></tr>";
}
...
<link href="css/app.46643acf.css" rel="stylesheet">
    ...
    <link rel="apple-touch-icon" href="/img/recharge.png">
    <style>
body {
...
">Jhon Doe</h6>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="rechargeRequests" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Recharge Req</a>
